...
Satisfies: [E-CROSS-PLATFORM](../expectations.md) (`S-ARCH-*`), [E-STANDARDS](../expectations.md) (shared-core architecture).

- [S-ARCH-1] Shared core in Rust with platform-appropriate bindings for each shell:
