...
- **Block-id** — Stable identifier for a block within a note, used as the target of intra-note and inter-note references. (Generation rule is an open item — see @S-DM-NR5, marked `TBD post-POC`.)
