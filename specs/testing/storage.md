...
- Each test heading lists the spec IDs it covers in `@CODE` notation.
...
> **Provisional**: covers the currently implemented candidate definition behaviour in @(S-DM-ND1,S-DM-ND2). Broader syntax options and richer definition metadata remain deferred.
