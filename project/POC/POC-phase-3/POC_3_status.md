...
|---|------|-----------|--------|------------|
| 3.1 | File upload → artifact | Phase 2 (2.2) | Done | [3.1_file-upload.md](POC-phase-3/3.1_file-upload.md) |
| 3.2 | Paste from clipboard → artifact | Phase 2 (2.2) | Done | [3.2_paste-from-clipboard.md](POC-phase-3/3.2_paste-from-clipboard.md) |
| 3.3 | Screen region capture → artifact | Phase 2 (2.2) | Done | [3.3_screen-region-capture.md](POC-phase-3/3.3_screen-region-capture.md) |
| 3.4 | File/media preview in editor | 3.1 | Done | [3.4_file-media-preview.md](POC-phase-3/3.4_file-media-preview.md) |
